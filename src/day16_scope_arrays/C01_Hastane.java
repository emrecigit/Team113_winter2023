...
public class C01_Hastane {
    public static void main(String[] args) {
        ...
        System.out.println(dok1); // referansini yazdirir. // day16_scope_arrays.ADoktor@378bf509
        System.out.println(dok1.fakulte); // Tip
        System.out.println(dok1.fakulte); // Tip

        dok1.isim ="Burcu";
        System.out.println(dok2.isim);// null
        dok1.fakulte="Tip fakultesi"; // static deger burdan itibaren atama yapildiktan sonra fakulte artik Tip fakultesi oldu
        ...
        //erisim yontemi classAdi.staticVariableAdi seklinde yazimdir.
